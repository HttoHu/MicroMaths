...
// .... One dollar equation -- 1美元方程,  来自(come from) Google Translator  要打去打Google ( 逃 ~ 其实这名字不错的
...
namespace Micx.Pages.Home
{
    ...
    /// </summary>
    public sealed partial class OneDollarEquation : Page
    {
        ...
        {
            txt_AnswerTextBlock.Text =GuassRT.Equation.Solve(inputBox.Text);
            Micx.Class.ResultData.Histroy.SetValue( inputBox.Text, txt_AnswerTextBlock.Text);
        }
